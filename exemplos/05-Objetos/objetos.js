...
let atriz = { // Declaração deum objeto chamado "atriz" 
    nome: 'Angelina Jolie', 
...
let celebridade = {
    ...
    idade: 37,
    sexo: 'feminino',
    filmes: ['Lost in translation', 'The Avangers', 'Marriage Story'], //Array 
    cidade: 'Nova york',
    medidas: {// Objetivo dois "medidas")
        peso: 57, 
        altura: 1.60,
    }
};
...
document.write(`Meu filmefavorito é: <strong>${filmesFamosos[1].título} </strong> dirigido por <strong>${filmesFamosos[1].diretor}</strong>`)
