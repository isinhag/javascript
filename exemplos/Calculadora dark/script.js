...
// Converter a coleção de botões em um array para que possamos percorrer sobre eles.
...
arr.forEach(button => {
    ...
    button.addEventListener('click', (e) => {
        ...
        if (e.target.innerHTML == '=') {
            // A função eval() é uma função JavaScript que avalia e executa dinamicament o código. Quando a linha é executada, o JavaScript interpreta o conteúdo de string como uma expressão e a avalia. No exemplo dado, eval("2 + 2") resultaria em 4, porque ele calcula a soma.
            string = eval(string);
